...
Status: historical product specification. This document records the original MVP target and design questions that led to Eventloom. For current v1.0 compatibility boundaries, release gates, and shipped scope, use [Eventloom v1.0.0 Roadmap](roadmap-v1.md), [Public API](public-api.md), and [Migration Notes](migration-v1.md).
