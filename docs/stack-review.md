...
Status: historical stack decision note. This document explains why the prototype started as a TypeScript, Node.js, JSONL, Zod, and Vitest runtime. For current v1.0 release scope and package contracts, use [Eventloom v1.0.0 Roadmap](roadmap-v1.md), [Public API](public-api.md), and [Release Checklist](release.md).
