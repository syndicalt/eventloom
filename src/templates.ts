/**
 * Starter recipe for recording a common agent workflow as Eventloom events.
 */
...
/**
 * Event stub included in an agent workflow template.
 */
...
/**
 * Looks up a packaged agent workflow template by stable template id.
 */
...
/**
 * Formats the packaged agent workflow template catalog for CLI and agent-facing docs.
 */
...
/**
 * Formats one agent workflow template with ordered event stubs for CLI inspection.
 */
