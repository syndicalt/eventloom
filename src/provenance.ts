...
/**
 * Package and Git metadata attached to Eventloom exports for trace provenance.
 */
...
/**
 * Collects package metadata and best-effort Git state for the current Eventloom runtime checkout.
 */
